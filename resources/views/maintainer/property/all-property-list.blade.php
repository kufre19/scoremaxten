...
@section('content')
                            ...
                            <div
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item"><a href="{{ route('maintainer.dashboard') }}"
                                    ...
                                    @forelse($properties as $property)
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-3">
                                            <div
                                                ...
                                                <a href="{{ route('maintainer.showProperty', $property->id) }}"
    ...
    <input type="hidden" id="getAllPropertyRoute" value="{{ route('maintainer.allProperty') }}">
@endsection
@if (getOption('app_card_data_show', 1) != 1)
    @push('style')
